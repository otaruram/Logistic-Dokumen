...
const OptionsTab = () => {
  ...
  const handleConnectTelegram = async () => {
    ...
    try {
      ...
      setStatus({ connected: json.is_linked, has_key: true, tele_key: json.tele_key, deep_link: json.deep_link, selected_bot: json.selected_bot });
      ...
      >
        ...
        {status?.has_key && (
          <div className="space-y-2 border-t border-white/10 pt-3">
            ...
            <p className="text-[11px] text-gray-500">
              Bot aktif: {status.selected_bot === "otaru_finance" ? "@otarufinance_bot" : "@otaruchain_bot"}
            </p>
          </div>
        )}
      </motion.div>
