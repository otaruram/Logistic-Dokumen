...
import { AlertCircle, ClipboardList, Info, PenLine, RefreshCw, Shield, Sparkles, X } from "lucide-react";
...
export default function ApprovalQueueTab() {
  ...
  const _initCanvas = (canvas: HTMLCanvasElement) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h3 className="text-lg font-semibold text-zinc-900">Tanda Tangan Digital</h3>
            ...
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-[11px] text-zinc-500">Tap dulu tombol ini di HP sebelum menulis tanda tangan.</span>
            </div>
            <canvas
              ref={canvasRef}
              width={400}
            ...
            <div className="mt-2">
              <p className="mb-1 text-[11px] text-zinc-500">Pilih jenis cap:</p>
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => setStampStyle("embossed")}
                  className={`rounded-full border px-3 py-1.5 text-[11px] font-semibold ${
                    stampStyle === "embossed"
                      ? "border-red-600 bg-red-600 text-white"
                      : "border-zinc-300 bg-white text-zinc-700"
      ...
      {rejectLoan && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h3 className="text-lg font-semibold text-zinc-900">Tolak Pengajuan</h3>
                <p className="text-sm text-zinc-500 mt-0.5">
            ...
            <textarea
              ...
              rows={3}
              placeholder="Contoh: Nominal melebihi batas, dokumen tidak jelas, dll."
              className="w-full rounded-xl border border-zinc-300 px-3 py-2 text-sm text-zinc-800 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-400 resize-none"
            />
            {rejectError && (
              <p className="mt-3 text-sm text-red-600 bg-red-50 rounded-lg p-3">{rejectError}</p>
            )}
            <div className="mt-4 flex gap-2">
              <button
                onClick={() => setRejectLoan(null)}
      ...
      {revisionLoan && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h3 className="text-lg font-semibold text-zinc-900">Perlu Revisi</h3>
                <p className="text-sm text-zinc-500 mt-0.5">
            ...
            <textarea
              ...
              rows={3}
              placeholder="Contoh: Foto dokumen kurang jelas, harap upload ulang dengan pencahayaan lebih baik."
              className="w-full rounded-xl border border-zinc-300 px-3 py-2 text-sm text-zinc-800 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-amber-300 resize-none"
            />
            {revisionError && (
              <p className="mt-3 text-sm text-red-600 bg-red-50 rounded-lg p-3">{revisionError}</p>
            )}
            <div className="mt-4 flex gap-2">
              <button
                onClick={() => setRevisionLoan(null)}
              ...
              >
                {revisioning ? "Mengirim..." : "Kirim Notif Revisi"}
              </button>
            </div>
          </div>
        </div>
