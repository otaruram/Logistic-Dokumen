...
class Settings:
    ...
    PROD_FE_URL: str = os.getenv('PROD_FE_URL', 'https://otaruchain.id')
    ...
    TELEGRAM_FINANCE_BOT_TOKEN: str = os.getenv('TELEGRAM_FINANCE_BOT_TOKEN', '')
    TELEGRAM_FINANCE_BOT_USERNAME: str = os.getenv('TELEGRAM_FINANCE_BOT_USERNAME', 'otarufinance_bot')
    TELEGRAM_MAIN_WEBHOOK_SECRET: str = os.getenv('TELEGRAM_MAIN_WEBHOOK_SECRET', '')
    TELEGRAM_FINANCE_WEBHOOK_SECRET: str = os.getenv('TELEGRAM_FINANCE_WEBHOOK_SECRET', '')
    TELEGRAM_ADMIN_CHAT_ID: str = os.getenv('TELEGRAM_ADMIN_CHAT_ID', '')  # Admin chat to receive form submissions

    # Backend base URL (used by workers to call own API)
