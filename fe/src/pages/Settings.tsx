...
import { Moon, Sun, Monitor, HardDrive, ArrowLeft, Trash2, ShieldAlert } from "lucide-react";
...
export default function Settings() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-zinc-950 font-sans text-[#1A1A1A] dark:text-white">
      <Header user={user} onLogout={() => { sessionStorage.clear(); navigate('/landing'); }} onProfile={() => navigate('/profile')} onSettings={() => {}} />

      <main className="container mx-auto px-4 py-8 max-w-2xl">
        <Button variant="ghost" onClick={() => navigate(-1)} className="mb-6 pl-0 hover:bg-transparent hover:text-gray-500">
