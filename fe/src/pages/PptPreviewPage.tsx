...
const PptPreviewPage = () => {
    ...
    const getContainerClass = () => {
        switch (deviceMode) {
            case 'mobile': return 'max-w-lg mx-auto border-x border-neutral-800'; // Default mobile look
            case 'tablet': return 'max-w-3xl mx-auto border-x border-neutral-800'; // Tablet width
            case 'desktop': return 'w-full max-w-7xl mx-auto px-4'; // Desktop full width constrained
            default: return 'max-w-lg mx-auto';
        }
    };

    return (
        <div className={`min-h-screen bg-neutral-950 text-white flex flex-col transition-all duration-300 ${getContainerClass()}`}>
            {/* Minimalist Header */}
