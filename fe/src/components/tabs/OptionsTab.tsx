...
import { Moon, Sun, Globe, Trash2, HelpCircle, ChevronRight, Bell, Shield } from "lucide-react";
  ...
  const settingsGroups = [
    {
      ...
      items: [
        ...
        },
        {
          icon: Globe,
          label: "Language",
          value: language === "id" ? "Indonesia" : "English",
          action: () => {
            setLanguage(language === "id" ? "en" : "id");
            toast.success(`Language changed to ${language === "id" ? "English" : "Indonesia"}`);
          },
        },
      ],
    },
